...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Si existe el botón de imprimir factura, agregar evento
    if (imprimirFacturaBtn) {
        imprimirFacturaBtn.addEventListener('click', () => {
            const facturaActual = document.getElementById('factura-container').innerHTML;
            const ventanaImpresion = window.open('', '_blank');
            ventanaImpresion.document.write(`
                <html>
                <head>
                    <title>Factura EnvíoDinero GE</title>
                    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
                    <style>
                        body { font-family: 'Calibri', sans-serif; padding: 20px; }
                        .factura-header { text-align: center; margin-bottom: 1.5rem; border-bottom: 2px solid #333; padding-bottom: 1rem; }
                        .factura-header h2 { margin-bottom: 0.5rem; color: #2d5b88; font-weight: bold; }
                        .factura-tabla { width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; border: 2px solid #dee2e6; }
                        .factura-tabla td, .factura-tabla th { padding: 0.75rem; border: 1px solid #dee2e6; }
                        ...
                        .factura-footer { text-align: center; margin-top: 1.5rem; border-top: 1px dashed #adb5bd; padding-top: 1rem; color: #6c757d; }
